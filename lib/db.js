    ...
    },
    {
        ...
        exercises: [
            ...
            },
            {
                ...
                sets: 3,
                reps: '20',
                notes: 'Foco no contorno lateral do glúteo médio.',
                cadence: { concentric: 1.0, peakHold: 1.0, eccentric: 1.0, baseHold: 0, restTime: 45 }
            },
        ]
    },
    {
...
export async function getWorkout(id) {
    try {
        ...
        // This ensures old saved workouts get new code features
