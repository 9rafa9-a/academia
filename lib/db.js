...
const INITIAL_WORKOUTS = [
    {
        ...
        exercises: [
            {
                name: 'Agachamento ou Leg Press',
                sets: 3,
                reps: '10-12',
                notes: 'Pés ligeiramente mais afastados que ombros (fêmur longo)',
                cadence: { concentric: 1.0, peakHold: 0.5, eccentric: 3.0, baseHold: 0.5, restTime: 90 }
            },
            {
                name: 'Supino Inclinado (Halteres)',
                sets: 3,
                reps: '10',
                notes: 'Foque na porção superior. Escápulas travadas.',
                cadence: { concentric: 1.0, peakHold: 0.5, eccentric: 3.0, baseHold: 1.0, restTime: 90 }
            },
            {
                name: 'Puxada Vertical Aberta',
                sets: 3,
                reps: '10',
                notes: 'Cotovelos em direção aos bolsos laterais.',
                cadence: { concentric: 1.0, peakHold: 1.0, eccentric: 3.0, baseHold: 0.5, restTime: 75 }
            },
            {
                name: 'Elevação Lateral',
                sets: 4,
                reps: '15',
                notes: 'Suba até a altura dos ombros. Braços levemente flexionados.',
                cadence: { concentric: 1.0, peakHold: 1.0, eccentric: 2.0, baseHold: 0, restTime: 60 }
            },
            {
                name: 'Cadeira Flexora',
                sets: 3,
                reps: '12',
                notes: 'Controle a volta (excêntrica) para densidade.',
                cadence: { concentric: 1.0, peakHold: 0, eccentric: 4.0, baseHold: 0, restTime: 60 }
            },
            {
                name: 'Face Pull (Corda)',
                sets: 3,
                reps: '15',
                notes: 'Puxe em direção à testa (duplo bíceps).',
                cadence: { concentric: 1.0, peakHold: 2.0, eccentric: 2.0, baseHold: 0, restTime: 60 }
            },
        ]
    },
    {
        ...
        exercises: [
            {
                ...
                sets: 3,
                reps: '10',
                notes: 'Coluna neutra. Sinta alongamento posterior.',
                cadence: { concentric: 1.0, peakHold: 0, eccentric: 3.0, baseHold: 1.0, restTime: 90 }
            },
            {
                name: 'Cadeira Extensora',
                sets: 3,
                reps: '12',
                notes: 'Segure 1s no topo (ponto máximo de contração).',
                cadence: { concentric: 1.0, peakHold: 1.0, eccentric: 2.0, baseHold: 0, restTime: 60 }
            },
            {
                ...
                sets: 3,
                reps: '10',
                notes: 'Abra o peito no final, esmague as escápulas.',
                cadence: { concentric: 1.0, peakHold: 1.0, eccentric: 2.0, baseHold: 0.5, restTime: 75 }
            },
            {
                name: 'Desenvolvimento (Halteres)',
                sets: 3,
                reps: '10',
                notes: 'Não deixe os ombros subirem até as orelhas.',
                cadence: { concentric: 1.0, peakHold: 0.5, eccentric: 2.5, baseHold: 0, restTime: 90 }
            },
            {
                name: 'Paralelas ou Supino Reto',
                sets: 3,
                reps: '10',
                notes: 'Prefira halteres no supino para amplitude.',
                cadence: { concentric: 1.0, peakHold: 0.5, eccentric: 3.0, baseHold: 1.0, restTime: 90 }
            },
            {
                ...
                sets: 4,
                reps: '15',
                notes: 'Alongamento total e contração máxima.',
                cadence: { concentric: 1.0, peakHold: 2.0, eccentric: 3.0, baseHold: 1.0, restTime: 60 }
            },
        ]
    },
    {
